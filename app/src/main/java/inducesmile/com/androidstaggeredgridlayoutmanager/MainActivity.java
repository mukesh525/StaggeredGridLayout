...
public class MainActivity extends AppCompatActivity implements HandleClick{
    List<ItemObjects> gaggeredList; SolventRecyclerViewAdapter rcAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  recyclerView.setLayoutManager(new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL));
        ...
        rcAdapter = new SolventRecyclerViewAdapter(MainActivity.this, gaggeredList);
...
//    }
    ...
    public void onClick(int postion) {
        gaggeredList.remove(postion);
        rcAdapter.notifyItemRemoved(postion);
    }
}
